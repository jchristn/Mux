namespace Mux.Cli.App
{
    ...
    public sealed class MuxTuiApp : IDisposable
    {
        ...
        /// <param name="onWorkingDirectoryChanged">Optional callback invoked when the user changes the working directory with <c>/cwd</c>, so the caller can point future runs' tools at the new directory and re-substitute <c>{WorkingDirectory}</c> in the system prompt. Null disables live working-directory changes.</param>
