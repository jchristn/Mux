namespace Test.Shared
{
    ...
    public abstract class TestSuite
    {
        ...
        /// <param name="actual">The actual value.</param>
        /// <param name="message">An optional failure message.</param>
        /// <exception cref="Exception">Thrown when the values are equal.</exception>
        ...
        /// <param name="value">The value to check.</param>
        /// <param name="message">An optional failure message.</param>
        /// <exception cref="Exception">Thrown when the value is not null.</exception>
        ...
        /// <param name="message">An optional failure message.</param>
        /// <exception cref="Exception">Thrown when the substring is not found.</exception>
        ...
        /// <param name="message">An optional failure message.</param>
        /// <exception cref="Exception">Thrown when the string does not start with the prefix.</exception>
        ...
        /// <exception cref="Exception">Thrown when no exception or an unexpected exception type is thrown.</exception>
